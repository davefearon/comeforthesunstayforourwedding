...
$app->get('/', function ($lang = 'en') use ($app, $langs, $availableLangs) {
  ...
  $ua = $req->headers('HTTP_USER_AGENT');
  $pattern = "/android|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(ad|hone|od)|iris|kindle|lge |maemo|meego.+mobile|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino|playbook|silk/i";
  ...
  if( preg_match($pattern, $ua) == 1 || preg_match($pattern2, substr($ua, 0,4)) == 1 ) {
    $app->render('mobile.php', $langs);
  } else {
    //$app->render('relative.php', $langs);
    $app->render('absolute.php', $langs);
  }
});
